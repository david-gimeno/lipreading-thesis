...
from src.encoder.sim_t.my_branchformer.encoder_group import EBranchformerEncoderGroup

class MyBranchformerEncoderSimT(AbsEncoder):
    ...
    def __init__(
        ...
        self.encoders = repeat(
            num_groups,
            lambda lnum: EBranchformerEncoderGroup(
                output_size,
