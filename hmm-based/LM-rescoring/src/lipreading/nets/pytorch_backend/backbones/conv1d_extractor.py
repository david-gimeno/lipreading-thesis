...
import torch
import numpy as np
from src.lipreading.nets.pytorch_backend.backbones.modules.resnet1d import ResNet1D
from src.lipreading.nets.pytorch_backend.backbones.modules.resnet1d import BasicBlock1D
