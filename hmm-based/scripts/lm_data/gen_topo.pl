...
if (@ARGV != 5) {
  print STDERR "Usage: utils/gen_topo.pl <topology> <num-nonsilence-states> <num-silence-states> <colon-separated-nonsilence-phones> <colon-separated-silence-phones>\n";
  print STDERR "e.g.:  utils/gen_topo.pl A 3 5 4:5:6:7:8:9:10 1:2:3\n";
  exit (1);
}

($topology,$num_nonsil_states, $num_sil_states, $nonsil_phones, $sil_phones) = @ARGV;
...
if( $topology eq "B" ) {
    print "<State> 0 <PdfClass> 0 <Transition> 0 0.35 <Transition> 1 0.35 <Transition> 3 0.30 </State>\n";
    print "<State> 1 <PdfClass> 1 <Transition> 1 0.35 <Transition> 2 0.35 <Transition> 3 0.30 </State>\n";
    print "<State> 2 <PdfClass> 2 <Transition> 2 0.50 <Transition> 3 0.50 </State>\n";
    print "<State> 3 </State>\n"; 
} elsif( $topology eq "B_v1" ) {
    print "<State> 0 <PdfClass> 0 <Transition> 0 0.35 <Transition> 1 0.35 <Transition> 3 0.30 </State>\n";
    print "<State> 1 <PdfClass> 1 <Transition> 1 0.5 <Transition> 2 0.5 </State>\n";
    print "<State> 2 <PdfClass> 2 <Transition> 2 0.5 <Transition> 3 0.5 </State>\n";
    print "<State> 3 </State>\n"; 
} elsif( $topology eq "B_v2" ) {
    ...
    print "<State> 0 <PdfClass> 0 <Transition> 0 0.35 <Transition> 1 0.35 <Transition> 2 0.30 </State>\n";
    print "<State> 1 <PdfClass> 1 <Transition> 1 0.5 <Transition> 2 0.5 </State>\n";
    print "<State> 2 </State>\n";
} elsif( $topology eq "E") {
    print "<State> 0 <PdfClass> 0 <Transition> 0 0.5 <Transition> 1 0.5 </State>\n";
    print "<State> 1 </State>\n";
} elsif( $topology eq "chain" ) {
